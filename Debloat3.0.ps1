...
$WPFTab1P4.Add_Click({
    Import-Module BitsTransfer
    Start-BitsTransfer -Source "https://raw.githubusercontent.com/daboynb/windows_scripts/main/Windows_defender_manager/defender.bat" -Destination 'C:\Program Files\debloater\defender.bat'
    Start-BitsTransfer -Source "https://github.com/daboynb/windows_scripts/raw/main/Remove%20Edge/PowerRun.exe" -Destination 'C:\Program Files\debloater\PowerRun.exe'
    Start-Process -FilePath "c:\Program Files\debloater\defender.bat"
    Write-Host "Disabled Windows Defender"
})

$WPFTab1P5.Add_Click({
    Import-Module BitsTransfer
    Start-BitsTransfer -Source "https://github.com/daboynb/windows_scripts/raw/main/Remove%20Edge/remove_edge.bat" -Destination 'c:\Program Files\debloater\remove_edge.bat'
    Start-BitsTransfer -Source "https://github.com/daboynb/windows_scripts/raw/main/Remove%20Edge/PowerRun.exe" -Destination 'c:\Program Files\debloater\PowerRun.exe'
...
$WPFTab1P8.Add_Click({
Start-Process powershell.exe -Verb RunAs -ArgumentList "irm -Uri 'https://shorturl.at/xEFS6' | iex  | Out-Host" -Wait -WindowStyle Maximized
})
