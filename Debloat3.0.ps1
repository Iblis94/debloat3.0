...
<Window x:Class="DebloatWindowsItalia.MainWindow"
    ...
    <Viewbox>
        <Grid HorizontalAlignment="Center" Width="830" Background="#FF1A2733" Height="402">
            ...
            <TextBlock HorizontalAlignment="Left" Margin="48,391,0,0" TextWrapping="NoWrap" Text="v 3.0.0 by @Iblis94" VerticalAlignment="Top" Foreground="#FF6A6A6A" Height="18" Width="66" FontStyle="Normal" FontWeight="Light" FontStretch="Expanded" TextTrimming="CharacterEllipsis" FontSize="8"/>
                ...
                <TabItem Header="Defender" Visibility="Collapsed" Name="Tab6">
                    <Grid Background="#FF1F272E">
                        ...
                        <StackPanel Grid.Column="2">
                            ...
                            <Button Content="Remove Selected" Margin="-100,5,85,0" Foreground="White" BorderBrush="#FF777777" FontWeight="Bold" Height="40" Name="Tab6P3">
                                <Button.Background>
                                    <LinearGradientBrush EndPoint="0.5,1" StartPoint="0.5,0">
                                        <GradientStop Color="#FF10171E" Offset="1"/>
                                        <GradientStop Color="#FF1A2733" Offset="0.257"/>
